...
export type QueryToSQL<Params extends Record<string, any>, Schema extends object = {}, Query extends string = '', Key extends keyof Schema = keyof Schema> = 
...
export type QueryStringSQL<T extends string, S extends object = {}> = QueryToSQL<QueryStringToQueryParams<T>, S>

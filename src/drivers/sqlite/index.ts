...
import type { QueryParams as RemoveParams } from './remove'
import type { QueryParams as RemoveOneParams } from './remove-one'
import type { QueryParams as UpdateParams } from './update'
import type { QueryParams as UpdateOneParams } from './update-one'
...
import { raw as _removeRaw } from './remove'
import { raw as _removeOneRaw } from './remove-one'
import { raw as _updateRaw } from './update'
import { raw as _updateOneRaw } from './update-one'

/**
 * Create a SQLite database instance with the default connector.
 */
export function sqlite<const S extends Schema>(schema: S, db = createDefaultDb()) {
